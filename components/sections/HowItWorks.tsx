        ...
        <ol className="mt-14 grid gap-5 md:grid-cols-3">
          {howItWorks.steps.map((step, i) => (
            <Reveal as="li" key={step.n} delay={i * 90}>
              <div className="group relative h-full overflow-hidden rounded-[28px] border border-line bg-surface p-7 transition-transform duration-300 ease-spring hover:-translate-y-1 hover:shadow-lift">
                <span
                  aria-hidden="true"
